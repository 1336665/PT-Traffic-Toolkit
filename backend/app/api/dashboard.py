...
async def get_recent_activity(
    ...
    # Today's upload/download from SpeedLimitRecord
    from app.models import SpeedLimitRecord
    ...
    today_uploaded = speed_row.uploaded if speed_row else 0
    today_downloaded = speed_row.downloaded if speed_row else 0
