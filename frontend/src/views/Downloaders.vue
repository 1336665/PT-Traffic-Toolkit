              ...
              <td>
                <div class="flex items-center space-x-1">
                  <button
                    ...
                    class="p-1.5 hover:bg-green-100 dark:hover:bg-green-900/30 rounded-lg transition-colors"
                    title="恢复"
                  >
                    <PlayIcon class="w-4 h-4 text-green-600 dark:text-green-400" />
                  </button>
                  <button
                    v-else
                    @click.stop="pauseTorrent(torrent)"
                    class="p-1.5 hover:bg-yellow-100 dark:hover:bg-yellow-900/30 rounded-lg transition-colors"
                    title="暂停"
                  >
                    <PauseIcon class="w-4 h-4 text-yellow-600 dark:text-yellow-400" />
                  </button>
                  <button
